...
$(".container").hide();
$(".rechats").text("Hello Dev Nasfam, i saw the updates");
...
$(".container").hide();
$(".rechats").text("Hi Dev Nasfam, I need a loan from you!!");
$(".real_today").text("Yesterday");
$(".rtime").text(time);
});
...
$(".container").hide();
$(".rechats").text("Good job! Dev Nasfam, glad to see your code");
